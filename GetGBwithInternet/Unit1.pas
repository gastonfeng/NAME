    ...
    begin
      ...
      begin
        ...
        begin
          ...
          memo1.Lines.Add(chr(code1[i])+chr(code2[i])+':'+temp+'画');
        end
        else
        begin
          stroke[i]:=0;
          memo1.Lines.Add(chr(code1[i])+chr(code2[i])+':无此字');
